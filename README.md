...
- **Prefix presets:** SD 1.5, Pony, Illustrious, and Anima (`masterpiece, best quality, score_7, safe`), plus custom presets.
...
- **Multi-post merge:** On listing pages, select thumbnails with checkboxes. Then click Copy merged to copy a deduplicated set.
...
{
  format: "space",
  prefixPreset: "sd15", // none | sd15 | pony | illustrious | anima | custom
...
style.css     — Buttons, merge bar, and theme variables
manifest.json — MV3, 22 matches, commands
```
